...
static uint8_t *get_data_49_44() {
    ...
    uint64_t tmp_935ddd7251 = tmp_EHCIqh;
...
static uint8_t *get_data_49_46() {
    ...
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_79fdef7c42[i] = (uint32_t)tmp_EHCIqtd;
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x0, 0x4, (uint8_t *)tmp_79fdef7c42);
    free(tmp_79fdef7c42);
    uint32_t *tmp_e07405eb21 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_e07405eb21[i] = (uint32_t)tmp_EHCIqtd;
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x4, 0x4, (uint8_t *)tmp_e07405eb21);
    free(tmp_e07405eb21);
    uint32_t *tmp_864a7a50b4 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_864a7a50b4[i] = (uint32_t)get_data_from_pool4();
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x8, 0x4, (uint8_t *)tmp_864a7a50b4);
    free(tmp_864a7a50b4);
    ...
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0xc, 0x4, (uint8_t *)tmp_73581a8146);
    free(tmp_73581a8146);
    ...
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x10, 0x4, (uint8_t *)tmp_9cdf5a8653);
    free(tmp_9cdf5a8653);
    ...
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x14, 0x4, (uint8_t *)tmp_552116dd2b);
    free(tmp_552116dd2b);
    ...
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x18, 0x4, (uint8_t *)tmp_38018b47b2);
    free(tmp_38018b47b2);
    ...
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x1c, 0x4, (uint8_t *)tmp_1ea45cd693);
    free(tmp_1ea45cd693);
    uint32_t *tmp_1db53334fb = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_1db53334fb[i] = (uint32_t)tmp_EHCIqh;
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x0, 0x4, (uint8_t *)tmp_1db53334fb);
    free(tmp_1db53334fb);
    uint32_t *tmp_589f8779b0 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_589f8779b0[i] = (uint32_t)get_data_from_pool4();
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x4, 0x4, (uint8_t *)tmp_589f8779b0);
    free(tmp_589f8779b0);
    uint32_t *tmp_f87f43fdf6 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_f87f43fdf6[i] = (uint32_t)get_data_from_pool4();
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x8, 0x4, (uint8_t *)tmp_f87f43fdf6);
    free(tmp_f87f43fdf6);
    uint32_t *tmp_1fb797fab7 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_1fb797fab7[i] = (uint32_t)tmp_EHCIqtd;
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0xc, 0x4, (uint8_t *)tmp_1fb797fab7);
    free(tmp_1fb797fab7);
    uint32_t *tmp_8b53031d05 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_8b53031d05[i] = (uint32_t)tmp_EHCIqtd;
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x10, 0x4, (uint8_t *)tmp_8b53031d05);
    free(tmp_8b53031d05);
    uint32_t *tmp_11ebcd4942 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_11ebcd4942[i] = (uint32_t)tmp_EHCIqtd;
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x14, 0x4, (uint8_t *)tmp_11ebcd4942);
    free(tmp_11ebcd4942);
    uint32_t *tmp_a59cec9812 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_a59cec9812[i] = (uint32_t)get_data_from_pool4();
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x18, 0x4, (uint8_t *)tmp_a59cec9812);
    free(tmp_a59cec9812);
    ...
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x1c, 0x4, (uint8_t *)tmp_80ee526e0f);
    free(tmp_80ee526e0f);
    ...
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x20, 0x4, (uint8_t *)tmp_fcfcfa81b3);
    free(tmp_fcfcfa81b3);
    ...
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x24, 0x4, (uint8_t *)tmp_bb4a06cbe7);
    free(tmp_bb4a06cbe7);
    ...
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x28, 0x4, (uint8_t *)tmp_403d1f83a8);
    free(tmp_403d1f83a8);
    ...
    size_49_46 += serialize(Data, size_49_46, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x2c, 0x4, (uint8_t *)tmp_bdd7d19b75);
    free(tmp_bdd7d19b75);
    return Data;
}
...
static uint8_t *get_data_49_47() {
    ...
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_47e7f5938b[i] = (uint32_t)tmp_EHCIitd;
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x0, 0x4, (uint8_t *)tmp_47e7f5938b);
    free(tmp_47e7f5938b);
    uint32_t *tmp_ac642b4c49 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_ac642b4c49[i] = (uint32_t)get_data_from_pool4();
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x4, 0x4, (uint8_t *)tmp_ac642b4c49);
    free(tmp_ac642b4c49);
    uint32_t *tmp_b732d46f21 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_b732d46f21[i] = (uint32_t)get_data_from_pool4();
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x8, 0x4, (uint8_t *)tmp_b732d46f21);
    free(tmp_b732d46f21);
    uint32_t *tmp_bf9cc54563 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_bf9cc54563[i] = (uint32_t)get_data_from_pool4();
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0xc, 0x4, (uint8_t *)tmp_bf9cc54563);
    free(tmp_bf9cc54563);
    uint32_t *tmp_a69cfb85d4 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_a69cfb85d4[i] = (uint32_t)get_data_from_pool4();
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x10, 0x4, (uint8_t *)tmp_a69cfb85d4);
    free(tmp_a69cfb85d4);
    uint32_t *tmp_9836318900 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_9836318900[i] = (uint32_t)get_data_from_pool4();
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x14, 0x4, (uint8_t *)tmp_9836318900);
    free(tmp_9836318900);
    uint32_t *tmp_559b5975b2 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_559b5975b2[i] = (uint32_t)get_data_from_pool4();
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x18, 0x4, (uint8_t *)tmp_559b5975b2);
    free(tmp_559b5975b2);
    uint32_t *tmp_6a1689addf = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_6a1689addf[i] = (uint32_t)get_data_from_pool4();
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x1c, 0x4, (uint8_t *)tmp_6a1689addf);
    free(tmp_6a1689addf);
    uint32_t *tmp_b5816b74a9 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_b5816b74a9[i] = (uint32_t)get_data_from_pool4();
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x20, 0x4, (uint8_t *)tmp_b5816b74a9);
    free(tmp_b5816b74a9);
    ...
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x24, 0x4, (uint8_t *)tmp_b396905742);
    free(tmp_b396905742);
    ...
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x28, 0x4, (uint8_t *)tmp_9f6048fe24);
    free(tmp_9f6048fe24);
    ...
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x2c, 0x4, (uint8_t *)tmp_fa83ada4a2);
    free(tmp_fa83ada4a2);
    ...
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x30, 0x4, (uint8_t *)tmp_3c54c71fca);
    free(tmp_3c54c71fca);
    ...
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x34, 0x4, (uint8_t *)tmp_de59f550f0);
    free(tmp_de59f550f0);
    ...
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x38, 0x4, (uint8_t *)tmp_a636425c9b);
    free(tmp_a636425c9b);
    ...
    size_49_47 += serialize(Data, size_49_47, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x3c, 0x4, (uint8_t *)tmp_fa7ff8bfb0);
    free(tmp_fa7ff8bfb0);
    return Data;
}
...
static uint8_t *get_data_49_48() {
    ...
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_58d87776a5[i] = (uint32_t)tmp_EHCIsitd;
    size_49_48 += serialize(Data, size_49_48, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x0, 0x4, (uint8_t *)tmp_58d87776a5);
    free(tmp_58d87776a5);
    uint32_t *tmp_27896389df = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_27896389df[i] = (uint32_t)get_data_from_pool4();
    size_49_48 += serialize(Data, size_49_48, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x4, 0x4, (uint8_t *)tmp_27896389df);
    free(tmp_27896389df);
    uint32_t *tmp_4c14982d9e = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_4c14982d9e[i] = (uint32_t)get_data_from_pool4();
    size_49_48 += serialize(Data, size_49_48, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x8, 0x4, (uint8_t *)tmp_4c14982d9e);
    free(tmp_4c14982d9e);
    uint32_t *tmp_8ef066d442 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_8ef066d442[i] = (uint32_t)get_data_from_pool4();
    size_49_48 += serialize(Data, size_49_48, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0xc, 0x4, (uint8_t *)tmp_8ef066d442);
    free(tmp_8ef066d442);
    ...
    size_49_48 += serialize(Data, size_49_48, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x10, 0x4, (uint8_t *)tmp_6f790959a3);
    free(tmp_6f790959a3);
    ...
    size_49_48 += serialize(Data, size_49_48, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x14, 0x4, (uint8_t *)tmp_247145f4a8);
    free(tmp_247145f4a8);
    uint32_t *tmp_4578bab326 = (uint32_t *)malloc(0x4);
    for (int i = 0; i < (0x4) / 4; i++)
        tmp_4578bab326[i] = (uint32_t)tmp_EHCIsitd;
    size_49_48 += serialize(Data, size_49_48, CALLBACK_MAXSIZE, INTERFACE_MEM_WRITE, 0x18, 0x4, (uint8_t *)tmp_4578bab326);
    free(tmp_4578bab326);
    return Data;
}
